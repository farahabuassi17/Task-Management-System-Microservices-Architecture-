...
import com.farah.taskmanagement.taskservice.task.UpdateTaskStatusRequest;
...
public class TaskGraphqlController {
    ...
    @MutationMapping
    public TaskResponse updateTaskStatus(@Argument Long id, @Argument UpdateTaskStatusInput input) {
        return taskService.updateTaskStatus(id, new UpdateTaskStatusRequest(input.status()));
    }
}
